            ...
            <div class="col-sm-12" style="overflow: auto">
                <div class="id-card-holder">
                    <div class="id-card">
                        ...
                        <h6>Nome:&nbsp;<?= $carteira->getUsuario()->getPessoa()->getNome()." ". $carteira->getUsuario()->getPessoa()->getSobrenome() ?></h6>
                        <h6>Nascimento:&nbsp;<?= $carteira->getUsuario()->getPessoa()->getDataNascimento()->format('d/m/Y') ?></h6>
